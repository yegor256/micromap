...
| | 2 | 4 | 8 | 16 | 32 | 64 | 128 |
| --- | --: | --: | --: | --: | --: | --: | --: |
| `flurry::HashMap` | 333.66 | 78.20 | 36.60 | 18.34 | 7.86 | 5.27 | 2.97 |
| `hashbrown::HashMap` | 20.71 | 10.89 | 5.87 | 2.73 | 1.09 | 0.80 | 0.38 |
| `heapless::LinearMap` | 1.40 | 1.59 | 1.09 | 1.06 | 1.04 | 1.14 | 1.00 |
| `indexmap::IndexMap` | 12.23 | 10.90 | 6.88 | 3.57 | 1.50 | 1.01 | 0.49 |
| `linear_map::LinearMap` | 1.55 | 1.39 | 1.00 | 0.78 | 0.64 | 1.01 | 1.10 |
| `linked_hash_map::LinkedHashMap` | 27.67 | 19.00 | 10.96 | 5.73 | 2.28 | 1.57 | 0.76 |
| `litemap::LiteMap` | 1.56 | 2.23 | 4.01 | 3.56 | 1.29 | 1.02 | 0.60 |
| `micromap::Map` 👍 | 1.00 | 1.00 | 1.00 | 1.00 | 1.00 | 1.00 | 1.00 |
| `nohash_hasher::BuildNoHashHasher` | 20.20 | 10.90 | 6.41 | 2.65 | 1.02 | 0.70 | 0.37 |
| `rustc_hash::FxHashMap` | 20.22 | 10.85 | 5.90 | 2.64 | 0.93 | 0.65 | 0.32 |
| `std::collections::BTreeMap` | 24.24 | 14.16 | 8.84 | 5.31 | 1.97 | 1.37 | 0.78 |
| `std::collections::HashMap` | 20.55 | 12.93 | 7.67 | 4.00 | 1.72 | 1.13 | 0.56 |
| `tinymap::array_map::ArrayMap` | 1.59 | 3.90 | 3.81 | 3.69 | 3.06 | 4.79 | 4.55 |

The experiment [was performed][action] on 09-09-2025.
