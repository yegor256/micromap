...
| | 2 | 4 | 8 | 16 | 32 | 64 | 128 |
| --- | --: | --: | --: | --: | --: | --: | --: |
| `flurry::HashMap` | 337.96 | 77.10 | 40.33 | 16.02 | 11.99 | 5.34 | 2.88 |
| `hashbrown::HashMap` | 20.90 | 10.04 | 6.46 | 2.19 | 1.60 | 0.74 | 0.30 |
| `heapless::LinearMap` | 1.20 | 1.32 | 1.13 | 0.84 | 1.20 | 1.22 | 1.32 |
| `indexmap::IndexMap` | 16.81 | 13.50 | 9.11 | 6.03 | 2.83 | 1.28 | 0.76 |
| `linear_map::LinearMap` | 1.79 | 1.34 | 1.02 | 0.67 | 1.10 | 0.99 | 1.08 |
| `linked_hash_map::LinkedHashMap` | 27.00 | 18.16 | 11.45 | 4.71 | 3.71 | 1.70 | 0.80 |
| `litemap::LiteMap` | 1.67 | 1.96 | 5.58 | 2.37 | 2.12 | 0.99 | 0.61 |
| `micromap::Map` 👍 | 1.00 | 1.00 | 1.00 | 1.00 | 1.00 | 1.00 | 1.00 |
| `nohash_hasher::BuildNoHashHasher` | 20.66 | 10.14 | 7.33 | 2.06 | 1.53 | 0.68 | 0.36 |
| `rustc_hash::FxHashMap` | 20.99 | 10.14 | 6.37 | 2.04 | 1.28 | 0.63 | 0.33 |
| `std::collections::BTreeMap` | 20.58 | 8.57 | 5.05 | 2.77 | 2.33 | 1.15 | 0.72 |
| `std::collections::HashMap` | 20.69 | 12.58 | 8.11 | 3.20 | 2.53 | 1.10 | 0.57 |
| `tinymap::array_map::ArrayMap` | 2.00 | 3.86 | 3.94 | 3.04 | 4.90 | 4.67 | 4.76 |

The experiment [was performed][action] on 26-07-2025.
