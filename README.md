...
| | 2 | 4 | 8 | 16 | 32 | 64 | 128 |
| --- | --: | --: | --: | --: | --: | --: | --: |
| `flurry::HashMap` | 233.51 | 69.27 | 35.12 | 18.96 | 11.20 | 4.58 | 2.84 |
| `hashbrown::HashMap` | 20.76 | 10.58 | 5.72 | 3.05 | 1.53 | 0.61 | 0.31 |
| `heapless::LinearMap` | 1.46 | 1.43 | 2.96 | 2.59 | 1.57 | 0.98 | 1.00 |
| `indexmap::IndexMap` | 16.34 | 14.13 | 8.89 | 5.28 | 2.86 | 1.21 | 0.68 |
| `linear_map::LinearMap` | 1.77 | 1.39 | 0.98 | 0.86 | 0.95 | 0.97 | 0.98 |
| `linked_hash_map::LinkedHashMap` | 28.14 | 19.07 | 11.23 | 6.45 | 3.52 | 1.45 | 0.84 |
| `litemap::LiteMap` | 1.70 | 2.02 | 3.90 | 3.29 | 1.94 | 0.94 | 0.64 |
| `micromap::Map` 👍 | 1.00 | 1.00 | 1.00 | 1.00 | 1.00 | 1.00 | 1.00 |
| `nohash_hasher::BuildNoHashHasher` | 20.45 | 10.71 | 6.30 | 2.75 | 1.58 | 0.70 | 0.37 |
| `rustc_hash::FxHashMap` | 20.55 | 10.29 | 5.83 | 2.72 | 1.34 | 0.56 | 0.31 |
| `std::collections::BTreeMap` | 21.07 | 16.82 | 11.93 | 7.17 | 3.66 | 1.48 | 0.97 |
| `std::collections::HashMap` | 20.63 | 13.08 | 7.73 | 4.44 | 2.58 | 1.08 | 0.61 |
| `tinymap::array_map::ArrayMap` | 1.87 | 4.10 | 3.84 | 4.28 | 5.03 | 4.65 | 5.27 |

The experiment [was performed][action] on 21-11-2025.
