...
| | 2 | 4 | 8 | 16 | 32 | 64 | 128 |
| --- | --: | --: | --: | --: | --: | --: | --: |
| `flurry::HashMap` | 275.27 | 84.25 | 42.67 | 18.84 | 10.29 | 5.43 | 2.36 |
| `hashbrown::HashMap` | 21.48 | 10.88 | 6.17 | 2.67 | 1.42 | 0.63 | 0.27 |
| `heapless::LinearMap` | 1.42 | 1.35 | 1.14 | 1.06 | 0.96 | 1.54 | 1.25 |
| `indexmap::IndexMap` | 12.79 | 10.73 | 7.16 | 3.53 | 1.91 | 0.99 | 0.42 |
| `linear_map::LinearMap` | 1.61 | 1.39 | 1.05 | 0.78 | 1.04 | 0.97 | 0.86 |
| `linked_hash_map::LinkedHashMap` | 26.70 | 23.76 | 12.35 | 5.84 | 3.00 | 1.63 | 0.67 |
| `litemap::LiteMap` | 1.77 | 2.23 | 4.49 | 3.19 | 1.70 | 1.00 | 0.50 |
| `micromap::Map` 👍 | 1.00 | 1.00 | 1.00 | 1.00 | 1.00 | 1.00 | 1.00 |
| `nohash_hasher::BuildNoHashHasher` | 20.47 | 10.85 | 6.74 | 2.67 | 1.34 | 0.70 | 0.32 |
| `rustc_hash::FxHashMap` | 20.88 | 10.94 | 6.20 | 2.63 | 1.22 | 0.64 | 0.27 |
| `std::collections::BTreeMap` | 21.35 | 14.33 | 9.62 | 5.22 | 2.57 | 1.41 | 0.68 |
| `std::collections::HashMap` | 20.92 | 13.04 | 8.05 | 3.94 | 2.19 | 1.15 | 0.48 |
| `tinymap::array_map::ArrayMap` | 1.63 | 3.91 | 4.03 | 3.68 | 4.00 | 4.78 | 3.92 |

The experiment [was performed][action] on 19-09-2025.
