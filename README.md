...
| | 2 | 4 | 8 | 16 | 32 | 64 | 128 |
| --- | --: | --: | --: | --: | --: | --: | --: |
| `flurry::HashMap` | 292.11 | 76.88 | 38.46 | 14.56 | 11.94 | 3.67 | 2.27 |
| `hashbrown::HashMap` | 21.35 | 10.75 | 6.06 | 2.17 | 1.74 | 0.45 | 0.27 |
| `heapless::LinearMap` | 1.49 | 1.59 | 1.14 | 0.81 | 1.14 | 0.75 | 0.83 |
| `indexmap::IndexMap` | 12.71 | 10.86 | 7.00 | 2.76 | 2.21 | 0.69 | 0.42 |
| `linear_map::LinearMap` | 1.67 | 1.39 | 1.01 | 0.60 | 1.09 | 0.77 | 0.79 |
| `linked_hash_map::LinkedHashMap` | 27.28 | 20.44 | 13.17 | 4.54 | 3.50 | 1.08 | 0.68 |
| `litemap::LiteMap` | 1.79 | 2.02 | 4.11 | 2.42 | 1.94 | 0.69 | 0.52 |
| `micromap::Map` 👍 | 1.00 | 1.00 | 1.00 | 1.00 | 1.00 | 1.00 | 1.00 |
| `nohash_hasher::BuildNoHashHasher` | 20.77 | 10.92 | 6.61 | 2.07 | 1.58 | 0.52 | 0.32 |
| `rustc_hash::FxHashMap` | 20.36 | 10.83 | 6.14 | 2.05 | 1.41 | 0.40 | 0.27 |
| `std::collections::BTreeMap` | 22.07 | 14.34 | 9.57 | 4.12 | 3.00 | 0.96 | 0.66 |
| `std::collections::HashMap` | 21.07 | 12.89 | 7.93 | 3.10 | 2.54 | 0.77 | 0.47 |
| `tinymap::array_map::ArrayMap` | 1.98 | 3.92 | 3.93 | 2.86 | 4.63 | 3.25 | 4.40 |

The experiment [was performed][action] on 03-10-2025.
