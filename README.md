...
| | 2 | 4 | 8 | 16 | 32 | 64 | 128 |
| --- | --: | --: | --: | --: | --: | --: | --: |
| `flurry::HashMap` | 279.62 | 81.23 | 41.35 | 19.21 | 10.43 | 5.52 | 2.42 |
| `hashbrown::HashMap` | 21.14 | 10.85 | 6.17 | 2.56 | 1.33 | 0.63 | 0.28 |
| `heapless::LinearMap` | 1.41 | 1.33 | 1.14 | 1.07 | 0.96 | 1.55 | 1.23 |
| `indexmap::IndexMap` | 12.71 | 10.60 | 7.24 | 3.69 | 1.89 | 0.99 | 0.42 |
| `linear_map::LinearMap` | 1.58 | 1.37 | 1.04 | 0.78 | 1.04 | 1.01 | 0.85 |
| `linked_hash_map::LinkedHashMap` | 26.80 | 19.98 | 11.92 | 5.90 | 3.00 | 1.59 | 0.66 |
| `litemap::LiteMap` | 1.77 | 2.16 | 4.63 | 2.57 | 1.67 | 1.02 | 0.50 |
| `micromap::Map` 👍 | 1.00 | 1.00 | 1.00 | 1.00 | 1.00 | 1.00 | 1.00 |
| `nohash_hasher::BuildNoHashHasher` | 20.45 | 10.83 | 6.76 | 2.68 | 1.34 | 0.70 | 0.32 |
| `rustc_hash::FxHashMap` | 20.73 | 10.75 | 6.30 | 2.66 | 1.21 | 0.65 | 0.27 |
| `std::collections::BTreeMap` | 21.42 | 14.11 | 10.07 | 5.24 | 2.54 | 1.39 | 0.67 |
| `std::collections::HashMap` | 20.91 | 12.98 | 8.06 | 3.93 | 2.21 | 1.12 | 0.48 |
| `tinymap::array_map::ArrayMap` | 1.62 | 3.87 | 4.02 | 3.69 | 4.00 | 4.80 | 3.91 |

The experiment [was performed][action] on 23-08-2025.
